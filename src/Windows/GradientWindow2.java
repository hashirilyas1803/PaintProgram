...
public class GradientWindow2 extends PopUpWindow implements Interactibility {

    int xtemp;
    int ytemp;
    private RectangleTemplate[][] rectangles;
    public GradientWindow2(int x, int y, int width, int height, Color rectColor, Color lineColor, String text) {
